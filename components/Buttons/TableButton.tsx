export const FamilyLinkButton = ({
  ...
  return (
    <a onClick={() => updatePerson(personId)}>
      <strong className="rounded bg-indigo-100 px-3 py-1.5 text-xs font-medium text-indigo-700 flex flex-row items-center justify-between">
        {personName}{' '}
