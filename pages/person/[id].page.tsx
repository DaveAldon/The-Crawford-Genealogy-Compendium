...
import { getArtifactRowById, getPeopleRowById } from '../../lib/googlesheets';
      ...
      <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
        <div
          ...
          <div className="p-4 md:p-12 text-center lg:text-left">
            ...
            <h1 className="text-3xl font-bold pt-8 lg:pt-0">
              ...
              {` ${personResult.Middlename}`} {personResult.Lastname}
            </h1>
        ...
        <div className="w-full lg:w-2/5">
          <img
            src={imageSrc}
            onError={onError}
            className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block flex-shrink-0 min-w-full min-h-full"
          />
        </div>
      </div>
    </div>
...
export const getServerSideProps = async (context: any) => {
  ...
  const photosResult = await getArtifactRowById(
    GoogleSheetIds.Photos,
    context.query.id,
  );
  return { props: { personResult, photosResult } };
};
